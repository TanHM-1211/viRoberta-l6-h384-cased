...
from transformers import RobertaModel, RobertaTokenizerFast, RobertaTokenizer, RobertaConfig, RobertaForMaskedLM
import logging
import math
import os
import sys
...
def main():
    ...
    train_files = [os.path.join('./data/vietnews_merged', file) for file in sorted(os.listdir('./data/vietnews_merged'))]
    train_files += [os.path.join('./data/oscar-corpus', file) for file in sorted(os.listdir('./data/oscar-corpus'))]
    shuffle(train_files)
    data_args.train_file = train_files
